...
LeaveTypeAdapter.method('getFormFields', function() {
	return [
		...
		[ "name", {"label":"Leave Name","type":"text","allow-null":false}],
		[ "default_per_year", {"label":"Amount per year","type":"text","validation":"number"}],
		[ "location", {"label":"Location","type":"select","source":[["Office","Office"],["Site","Site"]]}],
		...
		[ "propotionate_on_joined_date", {"label":"Propotionate leaves on Joined Date","type":"select","source":[["Yes","Yes"],["No","No"]]}],
		[ "percentage", {"label":"Percentage %","type":"text"}]
	];
});

LeaveTypeAdapter.method('getFilters', function() {
	return [
...
LeaveRuleAdapter.method('getFormFields', function() {
	return [
	        [ "id", {"label":"ID","type":"hidden","validation":""}],
	        [ "name", {"label":"Leave Name","type":"text","allow-null":false}],
	        [ "default_per_year", {"label":"Leaves Per Year","type":"text","validation":"float"}],
			[ "location", {"label":"Location","type":"select","source":[["Office","Office"],["Site","Site"]]}],
...
LeaveRuleAdapter.method('getFilters', function() {
	return [
	        ["leave_group", {"label":"Leave Group","type":"select2","allow-null":true,"remote-source":["LeaveGroup","id","name"]}]     
	];
});
...
LeavePeriodAdapter.method('getLeaveDaysReadonly', function(leaveId) {
	...
	this.customAction('getLeaveDaysReadonly','admin_leaves',reqJson,callBackData);
});
...
WorkDayAdapter.method('doCustomValidation', function(params) {
	if((params.id == undefined || params.id == null) && params.country == "NULL"){
...
EmployeeLeaveAdapter.method('getLeaveDaysReadonlySuccessCallBack', function(callBackData) {
	...
	leaveCount = this.calculateNumberOfLeaves(days);
...
EmployeeLeaveAdapter.method('changeLeaveStatus', function() {
	...
	this.customAction('changeLeaveStatus','admin_leaves',reqJson,callBackData);
...
function LeaveGroupAdapter(endPoint) {
	this.initAdapter(endPoint);
}

LeaveGroupAdapter.inherits(AdapterBase);



LeaveGroupAdapter.method('getDataMapping', function() {
	return [
	        "id",
	        "name",
	        "details"
...
LeaveGroupAdapter.method('getHeaders', function() {
	return [
			{ "sTitle": "ID" ,"bVisible":false},
			{ "sTitle": "Name" },
			{ "sTitle": "Details" }
...
LeaveGroupAdapter.method('getFormFields', function() {
	return [
	        [ "id", {"label":"ID","type":"hidden","validation":""}],
	        [ "name", {"label":"Name","type":"text","validation":""}],
...
function LeaveGroupEmployeeAdapter(endPoint,tab,filter,orderBy) {
	this.initAdapter(endPoint,tab,filter,orderBy);
}

LeaveGroupEmployeeAdapter.inherits(AdapterBase);



LeaveGroupEmployeeAdapter.method('getDataMapping', function() {
	return [
	        "id",
	        "employee",
	        "leave_group"
...
LeaveGroupEmployeeAdapter.method('getHeaders', function() {
	return [
			{ "sTitle": "ID" ,"bVisible":false},
			{ "sTitle": "Employee" },
			{ "sTitle": "Leave Group" }
...
LeaveGroupEmployeeAdapter.method('getFormFields', function() {
	return [
	        [ "id", {"label":"ID","type":"hidden","validation":""}],
...
LeaveGroupEmployeeAdapter.method('getFilters', function() {
	return [
	        ["leave_group", {"label":"Leave Group","type":"select2","allow-null":true,"remote-source":["LeaveGroup","id","name"]}]     
	];
});
...
function LeaveStartingBalanceAdapter(endPoint) {
    this.initAdapter(endPoint);
}

LeaveStartingBalanceAdapter.inherits(AdapterBase);



LeaveStartingBalanceAdapter.method('getDataMapping', function() {
    return [
        "id",
        "leave_type",
        "employee",
...
LeaveStartingBalanceAdapter.method('getHeaders', function() {
    return [
        { "sTitle": "ID" ,"bVisible":false},
        { "sTitle": "Leave Type" },
        { "sTitle": "Employee"},
...
LeaveStartingBalanceAdapter.method('getFormFields', function() {
    return [
        [ "id", {"label":"ID","type":"hidden","validation":""}],
        [ "leave_type", {"label":"Leave Type","type":"select2","allow-null":false,"remote-source":["LeaveType","id","name"]}],
        [ "employee", {"label":"Employee","type":"select2","allow-null":false,"remote-source":["Employee","id","first_name+last_name"]}],
        [ "leave_period", {"label":"Leave Period","type":"select2","allow-null":false,"remote-source":["LeavePeriod","id","name"]}],
        [ "amount", {"label":"Leave Amount","type":"text","validation":"float"}],
        [ "note", {"label":"Note","type":"textarea","validation":"none"}]
    ];
});

LeaveStartingBalanceAdapter.method('getFilters', function() {
    return [
        [ "leave_type", {"label":"Leave Type","type":"select2","allow-null":true,"remote-source":["LeaveType","id","name"]}],
