...
class EmployeesActionManager extends SubActionManager
{
    ...
    public function getSalaryCompnents($id)
    {
        ...
        $totalPalenties = $loansTotal + $advantages + $taxes + $attendaceTotal + $vacations;
        $overTimeTotal = $this->getTotalOverTimeCost($id, $salary);
        $totalCompunctions = $overTimeTotal+$allowances;
            ...
            <h3>Salary Breakdown</h3>
                <div class="col-md-4">
                    ...
                    <div class="form-group form-inline">
                      <input type="text" id="Lateniess" class="form-control palenties" style="width:60px" value="' . $attendaceTotal . '">
                       <span class="">Lateniess</span>
                       <button class="btn btn-danger palenties Lateniess"style="margin-left: 60px;">Remove</button>
                       <script>
                    ...
                    <div class="form-group form-inline">
                      <input type="text" id="Advantages" class="form-control palenties " style="width:60px" value="' . $advantages . '">
                       <span class="">Advantages</span>
                       <button class="btn btn-danger palenties Advantages"style="margin-left: 45px;">Remove</button>
                       <script>
                      ...
                      <div class="form-group form-inline">
                      <input type="text" id="Loans" class="form-control palenties " style="width:60px" value="' . $loansTotal . '">
                       <span class="">Loans</span>
                       <button class="btn btn-danger palenties Loans"style="margin-left: 78px;">Remove</button>
                       <script>
                    ...
                    <div class="form-group form-inline">
                      <input type="text" id="Insurance" class="form-control palenties" style="width:60px" value="' . $taxes . '">
                       <span class="">Taxes And Insurance </span>
                       <button class="btn btn-danger palenties Insurance">Remove</button>
                       <script>
                     ...
                     <div class="form-group form-inline">
                      <input type="text" id="Vacations" class="form-control palenties" style="width:60px" value="'.$vacations.'">
                       <span class="">Unplanned Vacations</span>
                       <button class="btn btn-danger palenties Vacations">Remove</button>
                       <script>
                     ...
                     <div class="form-group form-inline">
                      <input type="text" id="Mobile" class="form-control palenties" style="width:60px" value="0">
                       <span class="">Mobile Plan</span>
                       <button class="btn btn-danger palenties Mobile" style="margin-left: 50px;">Remove</button>
                       <script>
                     ...
                     <div class="form-group form-inline">
                      <input type="text" id="Internet" class="form-control palenties" style="width:60px" value="0">
                       <span class="">Internet Plan</span>
                       <button class="btn btn-danger palenties Internet" style="margin-left: 42px;">Remove</button>
                       <script>
                  ...
                  <div class="form-group form-inline">
                      <input type="text" id="Others" class="form-control" style="width:60px" value="0">
                ...
                <div class="col-md-4">
                     <h3>Compensations</h3>
                    <div class="form-group form-inline">
                      <input type="text" class="form-control compensations" id="Overtime" style="width:50px" value="' . $overTimeTotal . '">
                       <span class="">Overtime </span>
                       <button class="btn btn-danger compensations OverTime" style="margin-left: 11px;">Remove</button>
                        <script>
                     ...
                     <div class="form-group form-inline">
                      <input type="text" class="form-control compensations" id="Allowances" style="width:50px" value="' . $allowances . '">
                       <span class="">Allowances </span>
                       <button class="btn btn-danger compensations Allowances">Remove</button>
                        <script>
                        $(".Allowances").on("click",function(){
                        $("#Allowances").val(0);
                            recalculateSalary();
                        });
                  ...
                  <div class="form-group form-inline">
                      <input type="text" id="OthersPlus" class="form-control" style="width:50px" value="0">
...
<col style="width: 253px">
  ...
  <tr>
    ...
    public function getJobDescription($req)
    {
        ...
        $html.='<h2>'.$jobTitle[0]->name.'</h2><br>';
        $department = new CompanyStructures();
        $department =  $department->Find('id = ?',array($jobTitle[0]->department));
        $html.='<h4>Department : '.$department[0]->title.'</h4><br>';
        $html.='<h4>Description : '.$jobTitle[0]->description.'</h4><br>';
        ...
        $allduties = implode(',',$allduties);
        $html.=$allduties.'</h4><br>';
        ...
        $html.='<h4>Languages :';
        $html.=$allLanguages.'</h4><br>';
        $html.='<h4>Location :';
        $html.=$jobTitle[0]->work_location.'</h4>';
        print_r($html);
        exit;
    }
