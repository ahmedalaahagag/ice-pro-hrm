...
<div class="span9">
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="tabPageTerminatedEmployees">
			<div id="TerminatedEmployees" class="reviewBlock" data-content="List" style="padding-left:5px;">
		
			</div>
			<div id="TerminatedEmployeesForm" class="reviewBlock" data-content="Form" style="padding-left:5px;display:none;">
...
modJsList['tabTerminatedEmployees'] = new TerminatedEmployeesAdapter('TerminatedEmployees','TerminatedEmployees',{"status":"Terminated"});
modJsList['tabTerminatedEmployees'].setRemoteTable(true);
