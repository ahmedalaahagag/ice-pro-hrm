...
?><div class="span9">
	...
	<ul class="nav nav-tabs" id="modTab" style="margin-bottom:0px;margin-left:5px;border-bottom: none;">
		<li class="active"><a id="tabSkills" href="#tabPageSkills">Skills</a></li>
		<li><a id="tabEducation" href="#tabPageEducation">Education</a></li>
		<li><a id="tabInstitutes" href="#tabPageInstitutes">Institutions</a></li>
	...
	<div class="tab-content">
		<div class="tab-pane active" id="tabPageSkill">
			<div id="Skills" class="reviewBlock" data-content="List" style="padding-left:5px;">
		
			</div>
			<div id="SkillsForm" class="reviewBlock" data-content="Form" style="padding-left:5px;display:none;">
		...
		<div class="tab-pane" id="tabPageInstitutes">
			<div id="Institutes" class="reviewBlock" data-content="List" style="padding-left:5px;">

			</div>
			<div id="InstitutesForm" class="reviewBlock" data-content="Form" style="padding-left:5px;display:none;">
...
modJsList['tabInstitutes'] = new InstitutionsAdapter('Institutes');
