...
EmployeePayslipAdapter.method('getDataMapping', function() {
    return [
        "id",
        "first_name",
        "last_name",
...
EmployeePayslipAdapter.method('getHeaders', function() {
    return [
        { "sTitle": "ID" ,"bVisible":false},
        { "sTitle": "First Name" },
        { "sTitle": "Last Name" },
...
EmployeePayslipAdapter.method('getFormFields', function() {
    return [
        [ "id", {"label":"ID","type":"hidden"}],
        [ "employee", {"label":"Employee","type":"select2","remote-source":["Employee","id","first_name+last_name"]}],
        [ "component", {"label":"Salary Component","type":"select2","remote-source":["SalaryComponent","id","name"]}],
...
EmployeePayslipAdapter.method('getFilters', function() {
    return [
        [ "employee", {"label":"Employee","type":"select2","remote-source":["Employee","id","first_name+last_name"]}]
    ];
});

EmployeePayslipAdapter.method('edit', function(id) {
    $( "button:contains('Print Bank Sheet')").hide();
    $.post(this.moduleRelativeURL, {'a': 'ca', 'req': id , 'mod': 'admin_employees', 'sa': 'getSalaryCompnents'}, function (data) {
        $("#EmployeeSalaryPayslip").hide();
        $("#EmployeeSalaryPayslipForm").html(data);
        $("#tabPageEmployeeSalaryPayslip").addClass('active');
        $("#EmployeeSalaryPayslipForm").show();
    })
});

EmployeePayslipAdapter.method('getActionButtonsHtml', function(id) {
    var html = '<div style="width:110px;"><img class="tableActionButton" src="_BASE_images/view.png" style="cursor:pointer;margin-left:15px;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img><img class="tableActionButton" src="_BASE_images/edit.png" style="display:none;cursor:pointer;margin-left:15px;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img></div>';
    html = html.replace(/_id_/g,id);
    html = html.replace(/_BASE_/g,this.baseUrl);
    return html;
});
EmployeePayslipAdapter.method('postRenderForm', function() {
    $( "button:contains('Print Bank Sheet')").hide();
});

EmployeePayslipAdapter.method('addPrintButton', function(id) {
...
EmployeePayslipAdapter.method('printSheet', function(id) {
    $.post(this.moduleRelativeURL, {'a': 'ca', 'req': id , 'mod': 'admin_employees', 'sa': 'getSalariesTable'}, function (data) {
        ...
        window.print();
        $("#print").hide();
        $("#EmployeeSalaryPayslip").show();
        $("#tabEmployeeSalaryPayslip").show();
        $( "button:contains('Print Bank Sheet')").show();
