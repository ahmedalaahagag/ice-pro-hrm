...
class BaseService{
	 ...
	 * @Param : $table : The table that will be queried for the data
	 * @Param : $mappingStr : maps fields to values
	 * @Param : $subSet : the field that will be queried
	 * @Param : $subSetValue : the value that will be queried
	 * @return : $list : set of sub data
	 */
