...
EmployeeTimeSheetAdapter.method('getTimeEntries', function() {
	...
	this.customAction('getTimeEntries','modules_timesheets',reqJson,callBackData);
});
...
EmployeeTimeSheetAdapter.method('createPreviousTimesheet', function(id) {
	...
	this.customAction('createPreviousTimesheet','modules_timesheets',reqJson,callBackData);
});
...
EmployeeTimeSheetAdapter.method('changeTimeSheetStatusWithId', function(id, status) {
	...
	this.customAction('changeTimeSheetStatus','modules_timesheets',reqJson,callBackData);
});
