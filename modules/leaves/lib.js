...
EmployeeLeaveAdapter.method('postRenderForm', function() {
	$.post(this.moduleRelativeURL, {'a': 'ca', 'req': "" , 'mod': 'admin_employees', 'sa': 'getLeaves'}, function (data) {
...
EmployeeLeaveAdapter.method('add', function(object,callBackData) {
	...
	this.customAction('addLeave','modules_leaves',reqJson,callBackData);
});
...
EmployeeLeaveAdapter.method('getLeaveDays', function() {
	...
	if(validator.checkValues()){
		...
		if(msg == null){
			...
			this.customAction('getLeaveDays','modules_leaves',reqJson,callBackData);
...
EmployeeLeaveAdapter.method('getLeaveDaysReadonly', function(leaveId) {
	...
	this.customAction('getLeaveDaysReadonly','modules_leaves',reqJson,callBackData);
});
...
SubEmployeeLeaveAdapter.method('changeLeaveStatus', function() {
	...
	this.customAction('changeLeaveStatus','modules_leaves',reqJson,callBackData);
...
EmployeeLeaveEntitlementAdapter.method('get', function() {
	...
	this.customAction('getEntitlement','modules_leaves',reqJson,callBackData);
});
