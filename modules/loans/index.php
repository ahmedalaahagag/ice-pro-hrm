...
?><div class="span9">
	...
	<ul class="nav nav-tabs" id="modTab" style="margin-bottom:0px;margin-left:5px;border-bottom: none;">
		<li class="active"><a id="tabEmployeeCompanyLoan" href="#tabPageEmployeeCompanyLoans">Loans</a></li>
		<li><a id="tabEmployeeExceptionalLoans" href="#tabPageEmployeeExceptionalLoans">Exceptional Loan</a></li>
	</ul>
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="tabPageEmployeeExceptionalLoans">
			<div id="EmployeeExceptionalLoans" class="reviewBlock" data-content="List" style="padding-left:5px;">

			</div>
			<div id="EmployeeExceptionalLoansForm" class="reviewBlock" data-content="Form" style="padding-left:5px;display:none;">
