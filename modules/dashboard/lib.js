...
DashboardAdapter.method('getPunch', function() {
	...
	this.customAction('getPunch','modules_attendance',reqJson,callBackData);
});
...
DashboardAdapter.method('getPendingLeaves', function() {
	...
	this.customAction('getPendingLeaves','modules_dashboard',reqJson,callBackData);
});
...
DashboardAdapter.method('getLastTimeSheetHours', function() {
	...
	this.customAction('getLastTimeSheetHours','modules_dashboard',reqJson,callBackData);
});
...
DashboardAdapter.method('getEmployeeActiveProjects', function() {
	...
	this.customAction('getEmployeeActiveProjects','modules_dashboard',reqJson,callBackData);
});
